...
import { WrapperTypeProduct, ProductItem, WrapperButtonMore, WrapperProducts, ProductCard } from './style'
...
const SearchPage = () => {
    ...
    const search = location.state?.dulieu;
    ...
    const fetchProductAll = async () => {
        const res = await ProductService.getSearch(search);
        return res;
    }
